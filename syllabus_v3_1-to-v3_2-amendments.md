...
*Authored 2026-07-22 by the orchestrator. At issue time it aligned the syllabus with **`capstone_V6_3.md` v6.3** (the strict-gate methodology amendment) and repaired two classes of stale content that predated it. The changes are **already applied** in `syllabus_v3_2.md`; this sheet is the historical change record for the amendment chain. Its version pointers are superseded by the 2026-08-02 v6.4 semantic rebase recorded in the live syllabus and `capstone_V6_3-to-V6_4-amendments.md`. No math-arc content, month structure, depth-label vocabulary, or historical delta entry was deleted. The SQL-A/SQL-B split is net-zero; the v6.3 offline-health rider adds at most ~8 h; the Month-2–4 labels now reflect the already-approved ~5–5.5-week pace; and the stale 6–6.5-month completion header is superseded by the ≈705 h envelope (G5 ~late-Jan/early-Feb 2027; G6 ~late-Mar/early-Apr 2027), with active applications still opening after G3 and no later than Month 5. All prior rejected-item records (LO3, LO2, SC3-learn, SC5-learn) carry forward unchanged.*
...
- New `v3.1 → v3.2 delta` entry appended after the v3.0→v3.1 delta. **At the 2026-07-22 issue point, all operative capstone references pointed to v6.3**; the later v6.4 semantic rebase supersedes that pointer while preserving the referenced section structure.
