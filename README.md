...
| **[Interactive Space](https://huggingface.co/spaces/Yarden-Viktor/delu-day-ahead-forecast)** | The marimo notebook exported to WebAssembly, served by a free **Static** Space; inference runs in the browser | about 57 MB on a first visit, 345 requests, 5 hosts |
