...
2. capstone_V6_5.md (the German DE-LU day-ahead price forecasting
   tool plan)
...
infer it from capstone_V6_5.md directly.
...
capstone_V6_5.md directly when possible.
...
syllabus_v3_2.md and capstone_V6_5.md. You are not responsible for
