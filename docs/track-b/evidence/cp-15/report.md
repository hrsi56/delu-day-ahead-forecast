...
**Engineering status: PASS. Fresh independent Integration binds candidate `fc4aee038cf898998a292506df62ddb0dcfaf22a`.** This evidence copy changes only the review status of the candidate report below. The original attempt-1 FAIL remains binding for its original candidate. The fresh verdict is `integration.md` in this directory.
