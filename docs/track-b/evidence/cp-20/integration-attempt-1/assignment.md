...
## Candidate
- Full SHA: a7943fb6262c1a50b729bd92fe701c8be9428038
- Clean detached worktree (created by the Lead with
  `git -C /Users/djourno/Downloads/PJM worktree add --detach /Users/djourno/Downloads/PJM/.local/worktrees/cp-20/critic a7943fb6262c1a50b729bd92fe701c8be9428038`):
  `/Users/djourno/Downloads/PJM/.local/worktrees/cp-20/critic`
...
- `reports/weather-ablation/`, `src/cp20/`, `scripts/cp20_weather.py`, `scripts/cp20_finalise.py`,
...
- Run every compute command through the monitor from the Critic worktree:
  `cd /Users/djourno/Downloads/PJM/.local/worktrees/cp-20/critic && $PY scripts/cp20_weather.py --monitor --name critic-<x> --workers 1 --log /Users/djourno/Downloads/PJM/.local/artifacts/cp-20/critic/logs/critic-<x>.log -- <command>`
...
- Write scripts, logs and outputs only under `/Users/djourno/Downloads/PJM/.local/artifacts/cp-20/critic/`
  (pytest `--basetemp` under `/Users/djourno/Downloads/PJM/.local/tmp/cp-20/critic/`; use
...
- Write one markdown verdict in the form of `docs/track-b/gauntlet-templates.md` §2 to
  `/Users/djourno/Downloads/PJM/.local/artifacts/cp-20/critic/integration.md`. The Lead commits it
