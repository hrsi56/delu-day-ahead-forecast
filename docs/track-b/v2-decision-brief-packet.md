...
**2026-09-23 · 4.0a/4.0b COMPLETE; v21-r3 CAP/COUNTING CHANGE RATIFIED; CP-16 RESUMPTION AUTHORIZED.**

The Owner has ratified the exact v21-r3 replay-cap/counting change and authorized resumption
of the existing CP-16 checkpoint: 6 passes / 9,000 cumulative policy-days, retaining all 3,730
historical debits and every other requirement. The rule and conditions below implement that
decision; no new budget proposal or general review is requested. No experiments or executor
launch in this Orchestrator task. The interrupted attempt remains BLOCKED/independent FAIL;
its evidence and limitations are preserved, with no inferred scientific result.

## 1. Basis, identity and existing decisions

The [current proposed programme plan](v3-plan-handoff-2026-09-22.md), §§2, 3.3, 4.B and
4.2, defines this packet. The [independent review of 23 September](v3-plan-independent-review-2026-09-23.md)
returns READY for bounded preparation, with no further general rewrite required. Its G-01
required the now-recorded specification ratification and execution grant; G-06 continues to
block unsupported economic qualification; G-02–G-05 concern
other routes and do not block this document or the proposed existing-input research route.
The [22 September review](v3-plan-independent-review-2026-09-22.md) supplies the underlying
comparison, pooling-control and contamination findings; its former rewrite findings were
closed by the September 23 review, not reopened here.

The ratified authority for CP-16 is now **v21-r3** in
[capstone_v21.md](../../capstone_v21.md). Historical v21-r1 remains preserved at
`evidence/cp-15:capstone_v21.md` for CP-15. The programme proposal remains a planning input,
not a replacement anchor. CP-15 is landed/closed, Engineering PASS and
`product_feasibility = NOT_DEMONSTRATED`; no successor is qualified or frozen.

| Historical input read in 4.0a | SHA256 of those historical bytes |
|---|---|
| Programme proposal, `v3-plan-handoff-2026-09-22.md` | `eb3c295581eb4731834458709c6b8678ef5cc2d86eb903b082a661529bd615d5` |
| Independent review, 2026-09-23 | `9ba1953b24b1a1bdeba9d34756dddab4bf781ad9de244209fc04f34e5bb56898` |
| Independent review, 2026-09-22 | `c1e5133b090ad25a4f6e9a8318a208369fe0a830706ad8b49956dc84b81e745f` |
| Ratified `capstone_v21.md` | `44ea4e545d2caa276a36a7a70db6ea044b3975196ead06f3ce59f976c83354b3` |
| `reports/cp15/protocol.json` | `051e4b7cdd1d5db68b26e6d6bc17333c4055c4bcbe5ea693d1d647fe355ccdd6` |
| `reports/cp15/scoring_metadata.json` | `ff7fe48bb2ed3b2b24cf630ac2f102c554846ea494fd3dc2a17a93e28165f1f7` |
| `reports/cp15/selection.json` | `1c498cbd19bc63c58cdbf75af3043465e0ec039c0d76a84acf00d223015a6a31` |

The historical programme proposal and v21-r1 anchor above match the identities examined
by the September 23 independent review. That review does not cover the revised bytes below.
Reported numerical findings below come from those reviews and the accepted
[CP-15 report](evidence/cp-15/report.md); this preparation recomputed no experimental result.

### Navigation-only revision and dated compatibility note — 2026-09-23

The Owner established the programme navigation repair and requested review of its exact
`task-only.diff` and `validation.json` under
`.local/artifacts/plan-navigation-20260923-012310/`. The diff was checked against both its
preserved `plan-before.md` and the current plan; the supplied patch exactly matches them.
The original hash remains in the historical table above and is not overwritten.

| Navigation identity / record | SHA256 |
|---|---|
| Historical plan input to 4.0a and earlier independent review | `eb3c295581eb4731834458709c6b8678ef5cc2d86eb903b082a661529bd615d5` |
| Current plan after navigation-only repair | `7fdd8205a06845e1bf34e3bba3028b78fb7c5c15013e2f9703e0ed602c4ed837` |
| Navigation task-only diff | `54fcafc0d4d972131c54c81993e6b420805ad9c506c8e3689066c2b99e01c41d` |
| Navigation validation record | `829aacb293c39660082bd64a9f3c692a6e781fb414e050fad94b8433ac317802` |

The validation record reports PASS: **24 indexed work-item IDs**, **419 internal links**,
**11 relative file links**, **59 explicit anchors**, **32 original headings** preserved,
no duplicate anchors, substantive requirements/route qualifiers and contamination disclosure
preserved, and compatible packet references. The Orchestrator checked the complete diff and
its before/after identity: after removing navigation formatting, the remaining changes are
expanded work-item shorthand and navigation labels. No substantive requirement change was
found. Packet references remain compatible with the [work-item index](v3-plan-handoff-2026-09-22.md#work-item-index).
This is a **navigation-only revision**, not a new general plan or new engineering review.

**Review coverage:** the September 23 independent reviewer examined `eb3c295581eb4731834458709c6b8678ef5cc2d86eb903b082a661529bd615d5`, not
`7fdd8205a06845e1bf34e3bba3028b78fb7c5c15013e2f9703e0ed602c4ed837`. This dated compatibility check does not claim that reviewer examined the new
navigation bytes, the prepared v21-r2 anchor or the final proposed brief. No plan rewrite
was commissioned or performed by 4.0b.

### Decisions already supplied — carry forward, do not re-ask

- **4.0a** produced one assembled packet and consistency check. The Owner subsequently
  approved O1–O3 and authorized the exact scoped **4.0b document completion** recorded here.
- Zero external cost; local M3/16 GB. Free registration/click-through may be acceptable
  in separately authorized work, but none is needed or performed for this packet.
- DE-LU hourly target, the deliberate **2019-01-01** input floor, original eligible rows,
  fixed **11:00 UTC on D−1** origin, separate Europe/Berlin delivery calendar, and complete-day
  **D−2** error-release/consume-once rules remain controlling. No new information is added.
- Historical §8 findings and v1 artifacts remain intact. Historical `p=.948` and
  peak `79/408` are not rewritten. New results on these development folds remain
  `development_post_selection`, even with a protocol committed before the new run.
- Governance Lockdown, independent Integration, local evidence preservation and Owner-only
  mainline/publication authority persist. The separate CP-16 execution grant is recorded
  in §4; no experiment occurs in this Orchestrator task. Only the two named locked files
...
remain distinct from ratification of the completed anchor and experiment authorization.

## 2. Owner decision sheet — approvals recorded 2026-09-23

**Owner-ratified experiment scope, CP-16 execution separately authorized:** a local research evaluation of point and interval forecasts,
using the fixed central blend `(A1.central + B2.central) / 2`, one causal hour-aware residual
construction and one otherwise identical pooled control. This isolates the pooling layer;
it is not a sweep over combinations, a new architecture or weather work.

The benefit is a decision about this particular construction, including a valid negative
finding. This research delivery is an intermediate step toward the unchanged live-system objective. Existing emitted-vector averaging scores do not predict its performance: the reviewed
`.64466/.62002` emitted blend and `.64070` central-only S_MAE are different policies.
The oracle `.589–.638` range is not a target, bound or leakage detector.

| Field / plan decision | Approved content and rationale | Actual authority state |
|---|---|---|
| **O1 — D1: next delivery and intended use** | **Research artifact**, for the Owner/technical reader deciding whether hour-aware uncertainty adds value on the fixed existing-input blend. Evaluate both point and interval forecasts. No asset, trading exposure, paying customer or service-level claim. A bounded research decision can finish without an invented commercial use case. | **APPROVED.** Research delivery covering both point and interval forecasts; intermediate step toward the unchanged live-system objective. |
| **O2 — D2: comparison, quality and economics** | Use pooled control for the layer's primary contrast, B2 as the strong fixed forecasting reference, B0 for normalization, and B1/A1 for context. Keep **all six original §8 criteria** as the unchanged product screen; no relaxed successor gate. Use the exploratory preference rule in §3.4 for research conclusions only. Economics remains **descriptive historical context only**, with zero new dispatch/backtest runs and no economic qualification. | **APPROVED.** Packet §§2–3.4 adopted. Development/post-selection labels and explicit mixed outcomes remain mandatory; no demonstrated joint preference is not equivalence or absence of benefit. |
| **O3 — D4: candidate/resource allowance** | Two new output policies; two unchanged LEAR components; five saved reference policies including B3 for the old screen; one fixed hour-shrinkage recipe, no residual hyperparameter search. Approved full numeric caps are in §3.5. This spends effort on a controlled hypothesis rather than another model family. | **APPROVED; v21-r3 replay cap/counting supersedes that one original allowance.** All other ceilings remain. Maxima are not targets or guarantees; Lead owns E1–E4 and remaining-work feasibility. |
| **O4 — D6: document completion versus final authority** | Scoped suspension for `capstone_v21.md` and `docs/track-b/capstone_v21-r1-to-v21-r2-amendments.md`; complete §14, amendment record and final proposed brief. | **DOCUMENT EDITS AUTHORIZED AND COMPLETED.** The later ratification and separate CP-16 execution grant are recorded in §4; they are distinct from O4. |

**Not unresolved blockers to this experiment:** D3 live/settlement/browser tradeoffs are deferred
because the default has no operation or commercial economics; the existing hourly research
resolution remains fixed. D5 weather fallback is inapplicable. D7 landing/publication remains
Owner-only and can wait after a completed local result. No TabPFN/DDNN licence, weather
admission, fresh-data period, live operator or research-content commission is requested here.
A changed product choice under O1/O2 would make the corresponding deferred decisions applicable.

**Known historical contamination:** the 90.9%/one-third-gap economic threshold was selected
*after* observing 90.7–91.4% candidate results. It is excluded, not repaired by a later CI or
new label. New criteria cannot make previously inspected data unseen. No economic winner,
annual value or causal-v2 gain is asserted.

## 3. Owner-ratified experiment specification — CP-16 execution authorized

The science and numerical ceilings below implement O1–O3. The Lead owns routine engineering
completion within them, not another Owner ballot. The ratified anchor §14 contains the
complete specification and checklist; separate CP-16 execution authorization is recorded in §4.
A material change or insufficient allowance must be reported explicitly.

### 3.1 Policies, population and information
...
### 3.2 Causal residual construction and fallback
...
### 3.3 Metrics, diagnostics and causal controls
...
### 3.4 Research conclusions and uncertainty — ratified O2 contract
...
### 3.5 Owner-approved numerical ceilings — v21-r3 resumption authorized
...
### 3.6 Engineering completion fields — Lead-owned, no new Owner ballots

| ID | Field to freeze under the adopted scope | Completion rule |
|---|---|---|
| **E1 — ENGINEERING PRE-RUN** | Exact permitted partition/key manifest, seven-day admission dates, ≤60-day warm-up dates, cache identity, fit/replay counts and missing-data feasibility | Resolve from metadata and permitted training data before comparison; verify support and totals against §3.5. Missing cache is not authority for extra fits. |
...
## 4. Historical grants and ratified v21-r3 successor identities

O1/O2 science and claims and original O4 preparation remain recorded above. Original v21-r2
prepared identities, retained as history:
...
Issued v21-r2 anchor `a05700ef6de700a956f6d8725cd45ecbc13f2384f780c309fffc5ba835d80a2d`, amendment
`09c663359ac2471a8adbc9865d8cbfa2a25e86062aebf8428411bb74614fadab` and brief
`1545089898aa47aa5384f5c6bcd07fda5ec7c0c98649cb44f2adba26cd0667ee` remain at evidence tip
`41b0e6d222a3d65d474ac5974c6eb7017db317e8`; the old amendment record is unchanged.

The Owner now ratifies the §3.5 / anchor §14.5 cap/counting change and authorizes CP-16
resumption under consistent successors without another routine approval round. Only the named
anchor scope and new v21-r2→v21-r3 amendment receive locked-file edits. The scoped suspension
ends at this document task's return; it grants no further governance-authoring power to Lead.
The 5 / 7,500 proposal is superseded. All 3,730 historical policy-days and other debits remain;
no retrospective compliance, re-scoring of debit or reset. §3.5 records the exact conditions.

| Current document | SHA256 |
|---|---|
| [Ratified v21-r3 anchor](../../capstone_v21.md) | `67d2176865fea4d6ada0b13bafb128016970d78337d5a936890ddbff7c3ad6ed` |
| [New amendment record](capstone_v21-r2-to-v21-r3-amendments.md) | `b2acadbfedecb22302a001f0935bd596d2c36a975742911e389b24e12a47142c` |
| [Issued resumption brief](cp-16-v2-brief.md) | `bd67e5852a2f59f15fac9d85214cf3d9e77483743b1728ab7e0cc80057471921` |
| [One-page handoff](cp-16-engineering-handoff.md) | `088d0b8c64e7c6004577a323cf906b54a9026d3fc2c39d08faf53050b8310b1e` |

Identity order: anchor → amendment → brief → handoff → packet/progress. The earlier independent
plan review covers its historical bytes only, not v21-r3 or this resumed engineering work.
Original §§8–9, historical CP-15 §12 and the entire CP-16 §14.8 checklist remain byte-identical.
All scientific rules and all non-replay resource ceilings remain unchanged.

## 5. Issued resumption and present state

The brief and one-page handoff reference the complete amended anchor and ten-item checklist
instead of repeating them. The Owner carries the handoff to the existing Lead. Resume
`gauntlet/cp-16` at the evidence tip above; retain the failed candidate
`3a160fd33ed92bb0061144cfbce2323d8b3a7db9`, all evidence and historical monitoring gaps.
No discard/restart. Lead reports remaining-work feasibility against every allowance before
experimental execution, regenerates inadequately monitored evidence required for results or
acceptance, and obtains fresh independent review of the complete bar. These are execution
responsibilities, not another Owner parameter/budget-design round. Weather §4.1 is no prerequisite.

## 6. Document consistency and preservation

**PASS — document checks only; resumption authorized, not performed by the Orchestrator.**
Anchor §14.5 and packet §3.5 match exactly apart from numbering. Science elsewhere and the
complete checklist are unchanged. Old prepared/issued identities, navigation-only provenance
and review coverage are preserved. No source, test, experimental evidence, original amendment,
Q&A, other locked document, index, ref or worktree is changed. Five existing authorized documents
changed; one new authorized amendment record was added. The existing Lead checkout remains clean.

No material document blocker remains. Lead feasibility/monitoring/regeneration/Integration
conditions remain required execution work, not claims that they have already passed. This
document task is bounded by two active hours, separately from unchanged checkpoint ceilings.
Complete task-only diff, status/stat, preservation and timing checks:
`.local/artifacts/cp16-v21-r3-2026-09-23/`. No further planning packet or general review.
