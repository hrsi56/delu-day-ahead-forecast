...
**Pre-confirmed:** CP-1 item 1 in full (A44/A65-A01/A69 non-empty for recent data -- Q1/Q3; 2019-01-01 archive depth confirmed for all three -- Q5; SMARD mirrors reachable -- Q6). Strong supporting evidence for item 3 (ENTSO-E<->SMARD sample: 100% of 96 hours within EUR 0.01/MWh -- Q6, full-history reconciliation remains an M1 job) and for the 15-min-boundary sub-clause of item 9 (continuity + exact hourly = mean-of-4-quarter-hours verified on the 2025-10-01 sample -- Q4).
...
The strict-gate methodology amendment (`capstone_V6_3.md`) reinterprets this probe's Q2 / Item-5 result **without changing any measurement above.** Archive stability (no overwrite) is confirmed and it resolves the R-2 *overwrite* risk — **but it does not make A69 available at the 12:00 gate.** The same probe established that A69/A01 for the delivery day is **not published until the 15:35–18:00 D-1 window, after the gate.** v6.3 therefore treats A69 as **post-gate → not KFT → excluded from the shipped champion** (capstone §5.2), with A69 and its derivatives confined to the §7.2 post-gate information benchmark. The correct reading of Item-5 at v6.3: *the archive faithfully preserves the as-published post-gate vintage* — which is precisely why that vintage may not enter the champion, only be measured in the benchmark. Any lagged-vintage gate-feasible proxy still requires independent **point-in-time provenance**.
