...
- Code SHA at the final run: `75b2b735dc42092df0f84e685b90a88b9f41cebe` — the commit whose tree produced these
...
| Final fit, freeze, sequential proof, holdout | 210.9 |
| Diagnostics (SHAP, permutation, regime, reliability) | 73.4 |
| **Total** | **724.1** |

No GPU, no cloud compute, $0 run rate. The champion's frozen artifact is
29.4 MB on disk and is logged
to MLflow as `models:/m-0b2e7cb3b7d24f869c51ebd18b620d5f`.
