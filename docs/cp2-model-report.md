...
- Code SHA at the final run: `0da432eef6bbaef7f4d654c9fc64851fd6e7084e` — the commit whose tree produced these
...
| Stage | Seconds |
|---|---|
| Development (baselines + both catalogs, 5 folds) | 223.7 |
| §7.2 post-gate benchmark | 216.1 |
| Final fit, freeze, sequential proof, holdout | 209.2 |
| Diagnostics (SHAP, permutation, regime, reliability) | 70.2 |
| **Total** | **719.2** |

No GPU, no cloud compute, $0 run rate. The champion's frozen artifact is
29.4 MB on disk and is logged
to MLflow as `models:/m-d170912010ce4f44ab8e8fd10dd1faf6`.
