...
- Code SHA at the final run: `a030331cc2185cf896ff750d7e88b9fa54693ca5` — the commit whose tree produced these
...
| Stage | Seconds |
|---|---|
| Development (baselines + both catalogs, 5 folds) | 220.3 |
| §7.2 post-gate benchmark | 217.7 |
| Final fit, freeze, sequential proof, holdout | 226.3 |
| Diagnostics (SHAP, permutation, regime, reliability) | 70.8 |
| **Total** | **735.1** |

No GPU, no cloud compute, $0 run rate. The champion's frozen artifact is
29.4 MB on disk and is logged
to MLflow as `models:/m-00089e4f61d24c049c5b050848c5158c`.
