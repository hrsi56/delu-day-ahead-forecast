...
- Code SHA at the final run: `380e7a0e9d37844da6d463ab67b33bc904b304e2` — the commit whose tree produced these
...
| Stage | Seconds |
|---|---|
| Development (baselines + both catalogs, 5 folds) | 228.2 |
| §7.2 post-gate benchmark | 215.1 |
| Final fit, freeze, sequential proof, holdout | 226.6 |
| Diagnostics (SHAP, permutation, regime, reliability) | 68.8 |
| **Total** | **738.7** |

No GPU, no cloud compute, $0 run rate. The champion's frozen artifact is
29.4 MB on disk and is logged
to MLflow as `models:/m-d3088afc6fe7488bba862ad9b5ad6a04`.
